...
var ChartDoughnut = function (_React$Component) {
  _inherits(ChartDoughnut, _React$Component);

  function ChartDoughnut(props) {
    _classCallCheck(this, ChartDoughnut);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ChartDoughnut).call(this, props));

    _this.state = { chr: "init" };
    return _this;
  }

  _createClass(ChartDoughnut, [{
    key: 'render',
    ...
    value: function componentDidMount() {
      ...
      this.state.chr = new Chart(ctx, { type: 'doughnut', data: ChartData, options: GlobalOptions });
    }
  }, {
...
module.exports = { ChartDoughnut: ChartDoughnut };
